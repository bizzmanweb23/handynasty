   ...
   /*Function to set JSON output*/
	...
	public function index() {
		...
		if(in_array('110',$role_resources_ids) || in_array('111',$role_resources_ids) || in_array('112',$role_resources_ids) || in_array('113',$role_resources_ids) || in_array('114',$role_resources_ids) || in_array('115',$role_resources_ids) || in_array('116',$role_resources_ids) || in_array('117',$role_resources_ids) || in_array('409',$role_resources_ids) || in_array('83',$role_resources_ids) || in_array('84',$role_resources_ids) || in_array('85',$role_resources_ids) || in_array('86',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/layout/hrsale_reports", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	}
	...
	public function payslip() {
		...
		if(in_array('111',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/reports/payslip", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	public function projects() {
		...
		if(in_array('114',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/reports/projects", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	public function tasks() {
		...
		if(in_array('115',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/reports/tasks", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	public function roles() {
		...
		if(in_array('116',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/reports/roles", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	public function employees() {
		...
		if(in_array('117',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/reports/employees", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	// get company > departments
	 public function get_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/report_get_departments", $data);
		} else {
			redirect('hrms/admin/');
		}
	 ...
	 public function designation() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/report_get_designations", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function employee_attendance() {
		...
		if(in_array('112',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/reports/employee_attendance", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	public function employee_leave() {
		...
		if(in_array('31',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/reports/employee_leave", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	public function employee_training() {
		...
		if(in_array('113',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/reports/employee_training", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	public function role_employees_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/roles", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function report_employees_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
		...
		$designation_id = $this->uri->segment(7);
	...
	public function task_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/tasks", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function project_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/projects", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
		...
		//echo $new_time;
		$project_summary = '<div class="text-semibold"><a href="'.site_url().'hrms/admin/project/detail/'.$r->project_id . '">'.$r->title.'</a></div>';
		$data[] = array(
			$project_summary,
			$priority,
			$start_date,
	...
	public function training_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/employee_training", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	// hourly_list > templates
	 public function payslip_report_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/payslip", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
		...
		$eid = $this->uri->segment(6);
		$re_date = $this->uri->segment(7);
	 ...
	 public function get_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/get_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_employees_att() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/get_employees_att", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
    ...
    public function empdtwise_attendance_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/employee_attendance", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	//	$full_name = $r->first_name.' '.$r->last_name;	
	 ...
	 public function employee_leave_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/reports/employee_leave", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
		...
		$sd = $this->uri->segment(5);
		$ed = $this->uri->segment(6);
	  ...
	  public function read_leave_details() {
		...
		$data = 'A';
		if(!empty($session)){ 
			$this->load->view('hrms/admin/reports/dialog_leave_details', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
